...
import PayUnpaidSubscription from "./components/subscription handlers/payUnpaidSubscription";
  ...
  return(
    ...
    <div className="App">
      <Switch>
        ...
        <PrivateRoute exact path="/pay_unpaid"name="Pay Unpaid Subscription" component={PayUnpaidSubscription}/>

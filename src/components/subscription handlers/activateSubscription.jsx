...
import {checkPayment} from "../../redux/actions/SubscriptionAction"
...
class activateSubscription extends Component{
    ...
    activateSubscription= async ()=>{
        ...
        let api = new Api();
        let data = await api.getData("/check_payment").then(({ data }) => data);
        this.setState({
            Pageloading:false
        })
        console.log(data)
    ...
    payUnpaid=()=>{
        this.props.props.history.push('/pay_unpaid')
                        ...
                        <div className="card user-data-card">
                            <div className="card-body">
                                ...
                                <div className="single-profile-data d-flex align-items-center justify-content-between">
                                    ...
                                    <div className="data-content"><button className="btn btn-success btn-sm"
                                                                    onClick={this.payUnpaid} >Pay</button></div>
                                </div>
                            </div>
                        </div>
                    }
